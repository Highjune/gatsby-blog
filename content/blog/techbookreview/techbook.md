...
## Pro Git 2/E
- ![progit](https://github.com/Highjune/TIL/assets/57219160/cbc25a4e-607d-4462-9212-98375fb065c7)
- 지은이 / 출판사
    - 스캇 샤콘, 벤 스트라웁 지움 박창우,이성환,최용재 옮김 / 인사이트
 - 읽은 시기(when)
    - 2022년 10월 ~ 2023년 09월
- 구매(how, where, why)
    - 누가 어디서 어떻게
        - 원래 이 책은 2020년에 국비지원 학원에 다닐 때 개인 사비로 산 책이다. 그런데 그 당시에는 너무 생소하고 어려워서 덮어준 상태로 안 봤다.
        - 그러다가 작년 10월쯤에 한바퀴 거의 다 봤었고 군데군데 체크한 부분들 안 본 상태서 1년간 미루다가, 이번에 나머지 보고 마무리함.
    - 왜 구매
        - Git의 가장 근본책이라고 다들 추천하길래 봄
- 후기(what)
    - 책이 두껍기는 하나, 그만큼 친절하게 git 의 구조에 대해서 잘 알려줘서 편했다. 
    - 이 책의 내용은 한번에 다 익히기보다 전반적인 구조에 대해서 공부한 후에, 필요할 때마다 찾아서 복습하는 식으로 공부하는 것이 더 좋을 것 같다.
