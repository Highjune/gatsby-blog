...
- `웨이트`
  ...
  - 그런데 웨이트가 나에게 너무나도 잘 맞다는 것. 174cm / 68kg 이었지만 지금은 76kg 까지 몸이 불었다. 스쿼트는 1rm 을 5개월 만에 140kg 에 이르렀다.
  - 무게보다는 부상 없이 꾸준히 하고 싶다는 것! (here)!
...
- `사랑`
  ...
  - 사실, 이것 역시 큰 모티베이션이 됐을 수도 있다고 생각했다.

- 웨이트

  -
  - 원래의 목표는 맨몸 운동의 꽃이라고 할 수 있는 플란체가 목표였다.
  - (플란체 사진)
  - 하지만 언제부터인지는 모르겠는데, 어느 순간 일명 헬창이라고 할 수 있는 몸매가 되고 싶은 욕심이 강해졌다.
  - (헬창 사진)
  - 마침,
  -

  무게에 대한 욕심. 등등 정말 오래해왔지만 하체를 제대로 하고 싶다는 생각이 들었었다.
